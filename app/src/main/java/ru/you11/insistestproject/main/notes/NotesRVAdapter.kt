...
class NotesRVAdapter(private val notes: List<Note>): RecyclerView.Adapter<NotesRVViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotesRVViewHolder {
        return NotesRVViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_note, parent, false))
    }
